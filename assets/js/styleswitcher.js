 ...
 * Created:   13/03/2022
 *
 * (c) Copyright by Nasuh Dincer Corp.
 */
jQuery(document).ready(function() {
    ...
    jQuery("#hideSwitcher, #showSwitcher").click(function () {
        ...
        if (jQuery("#showSwitcher").is(":visible")) {
            ...
            jQuery("#showSwitcher").show().animate({"margin-left": "0px"}, 500);
...
function setActiveStyleSheet(title) {
	...
	if(color_skin == 'dark') {
		...
		jQuery("head").append('<link id="css_dark_skin" href="assets/css/dark.css" rel="stylesheet" type="text/css" title="dark" />');
